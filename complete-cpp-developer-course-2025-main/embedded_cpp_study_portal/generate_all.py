...
<body>
  ...
  <main class="container">
    <section class="hero">
      ...
      <!-- Curriculum Key Statistics Grid -->
      <div class="hero-stats">
        <div class="stat-card">
          <div class="stat-number">116</div>
          <div class="stat-label">Total Projects</div>
          <div class="stat-sub">Projects 1.01 – 12.10</div>
        </div>
        <div class="stat-card">
          <div class="stat-number">12</div>
          <div class="stat-label">Domain Sections</div>
          <div class="stat-sub">Sec 1 – Sec 12</div>
        </div>
        <div class="stat-card">
          <div class="stat-number">68+</div>
          <div class="stat-label">Glossary Terms</div>
          <div class="stat-sub">Hardware &amp; Modern STL</div>
        </div>
        <div class="stat-card">
          <div class="stat-number">2</div>
          <div class="stat-label">Curriculum Tracks</div>
          <div class="stat-sub">Foundations &amp; Advanced</div>
        </div>
      </div>
    </section>
    ...
    <div class="track-switcher">
      <button class="track-btn active" data-track="all">
        ...
        <span class="track-badge">116 Projects (1.01–12.10)</span>
      </button>
      <button class="track-btn" data-track="foundations">
        <span>📘 Foundations Track</span>
        <span class="track-badge">61 Projects (1.01–6.06)</span>
      </button>
      <button class="track-btn" data-track="advanced">
        <span>🚀 Advanced Systems Track</span>
        <span class="track-badge">55 Projects (7.01–12.10)</span>
      </button>
    ...
    <section class="filter-panel">
      <div class="search-box">
        ...
        <input type="text" id="projectSearch" class="search-input" placeholder="Search 116 projects by number (e.g. 5.03, 11.01), concept (e.g. AAPCS, vtable, MMIO, DMA, LittleFS), name, or tag...">
      </div>
      <div class="filter-chips">
        <span class="filter-label">Filter by Section:</span>
        <button class="chip active" data-filter="all">All Sections (116)</button>
        <button class="chip" data-filter="sec-1">Sec 1: Toolchains (1.01–1.02 • 2)</button>
        <button class="chip" data-filter="sec-2">Sec 2: Types &amp; Vars (2.01–2.14 • 14)</button>
        <button class="chip" data-filter="sec-3">Sec 3: Control Flow (3.01–3.13 • 13)</button>
        <button class="chip" data-filter="sec-4">Sec 4: Arrays &amp; Locality (4.01–4.11 • 11)</button>
        <button class="chip" data-filter="sec-5">Sec 5: Functions &amp; AAPCS (5.01–5.15 • 15)</button>
        <button class="chip" data-filter="sec-6">Sec 6: OOP Foundations (6.01–6.06 • 6)</button>
        <button class="chip" data-filter="sec-7">Sec 7: Exceptions &amp; Faults (7.01–7.09 • 9)</button>
        <button class="chip" data-filter="sec-8">Sec 8: Pointers &amp; Memory (8.01–8.07 • 7)</button>
        <button class="chip" data-filter="sec-9">Sec 9: Streams &amp; Flash FS (9.01–9.07 • 7)</button>
        <button class="chip" data-filter="sec-10">Sec 10: OOP &amp; Enums (10.01–10.03 • 3)</button>
        <button class="chip" data-filter="sec-11">Sec 11: Templates &amp; STL (11.01–11.19 • 19)</button>
        <button class="chip" data-filter="sec-12">Sec 12: Data Structures (12.01–12.10 • 10)</button>
      </div>
    </section>
    ...
    <div class="track-header" id="header-foundations" data-track-header="foundations">
      <div class="track-title-wrap">
        ...
        <div>
          ...
          <p>Sections 1 through 6 &bull; Projects 1.01 – 6.06 &bull; Cross-Compilers, Data Types, Control Flow, Memory Locality, Calling Conventions &amp; OOP Foundations</p>
        </div>
      </div>
      <span class="track-count-badge">61 Projects (1.01–6.06)</span>
    </div>
    ...
    <div class="track-header advanced-header" id="header-advanced" data-track-header="advanced">
      <div class="track-title-wrap">
        ...
        <div>
          ...
          <p>Sections 7 through 12 &bull; Projects 7.01 – 12.10 &bull; Fault Handlers, Memory-Mapped I/O, Flash File Systems, Polymorphism &amp; CRTP, Modern STL &amp; Data Structures</p>
        </div>
      </div>
      <span class="track-count-badge">55 Projects (7.01–12.10)</span>
    </div>
